...
def addWatermark(request):
    ...
    if request.method == "POST":
        ...
        if data == "success_vid":
            ...
            if difference_w > 110:
                add_watermark_vid(input_video, output_video,
                                  watermark_image, 0.095, 3.9, 20)
            elif difference_w > 300:
                add_watermark_vid(input_video, output_video,
                                  watermark_image, 0.095, 3.4, 20)
            elif height == width:
                add_watermark_vid(input_video, output_video,
                                  watermark_image, 0.085, 3.9, 20)
            elif difference_h >= 200:
                add_watermark_vid(input_video, output_video,
                                  watermark_image, 0.068, 3, 20)
            else:
                add_watermark_vid(input_video, output_video,
                                  watermark_image, 0.085, "mdar", 20)
            return JsonResponse({"message": "success"})
        elif data == "success_photo":
            ...
            if difference_h > 190:
                print(1)
                add_watermark_img(input_img, output_img,
                                  watermark_image, 100, -8, 30)
            elif difference_w > 190:
                print(2)
                add_watermark_img(input_img, output_img,
                                  watermark_image, 120, -6, 30)
            elif difference_h < 190 and difference_h > 0:
                print(3)
                add_watermark_img(input_img, output_img,
                                  watermark_image, 230, 70, 30)

            elif difference_w < 190 and difference_w > 0:
                print(4)
                add_watermark_img(input_img, output_img,
                                  watermark_image, 195, 65, 30)
            elif difference_w == 0 and difference_h == 0:
                print(5)
                add_watermark_img(input_img, output_img,
                                  watermark_image, 130, -9, 30)
